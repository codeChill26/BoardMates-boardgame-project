...
function ComingSoon({ section }) {
  ...
  return (
    <div className="pt-24 sm:pt-28 md:pt-32 pb-16 md:pb-20 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto w-full">
      <section className="window-border window-shadow bg-surface-container-lowest overflow-hidden">
        ...
        <div className="p-5 sm:p-6 md:p-16 flex flex-col items-center text-center gap-5 sm:gap-6">
